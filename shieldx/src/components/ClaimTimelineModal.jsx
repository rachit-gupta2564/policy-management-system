...
export default function ClaimTimelineModal({ claim, onClose }) {
  ...
  return (
    <Modal title={`Claim Timeline — ${claim.id}`} onClose={onClose} footer={<BtnBrand onClick={onClose}>Close</BtnBrand>}>
      <div className="flex items-center gap-3 mb-6 pb-5 border-b border-gray-100">
        <div>
          ...
          <div className="text-sm text-gray-400 mt-0.5">{claim.amount} claimed</div>
        </div>
